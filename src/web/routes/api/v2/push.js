...
async function pushRoutes(fastify, options) {
  ...
  fastify.post('/subscribe', {
    ...
    try {
      ...
      console.log('[Push API] New subscription request');
   ...
   */
  fastify.delete('/subscribe/:subscriptionId', {
    schema: {
      params: {
        type: 'object',
        properties: {
    ...
    try {
      ...
      console.log('[Push API] Unsubscribe request:', subscriptionId);
   ...
   */
  fastify.post('/test/:subscriptionId', {
    schema: {
      params: {
        type: 'object',
        properties: {
    ...
    try {
      ...
      console.log('[Push API] Test notification request:', subscriptionId);
  ...
  fastify.post('/job-alert', {
    ...
    try {
      ...
      console.log('[Push API] Job alert notification:', jobData.title);
  ...
  fastify.post('/scraping-status', {
    ...
    try {
      ...
      console.log('[Push API] Scraping status notification:', status);
  ...
  fastify.post('/weekly-summary', {
    ...
    try {
      ...
      console.log('[Push API] Weekly summary notification:', summaryData);
  ...
  fastify.post('/cleanup', {
    ...
    try {
      console.log('[Push API] Cleanup expired subscriptions request');
