...
class JobAlertSystem {
  ...
  handleJobMatch(jobData) {
    ...
    this.showNotification(`New Job Match: ${jobData.title}`, {
  ...
  handleCreateAlert(formData) {
    const criteria = {
      ...
      minSalary: Number.parseInt(formData.get('minSalary')) || null,
      maxSalary: Number.parseInt(formData.get('maxSalary')) || null,
