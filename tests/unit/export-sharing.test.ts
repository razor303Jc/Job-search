...
describe('ExportSharingComponent', () => {
  ...
  describe('Quick Export', () => {
    ...
    it('should validate export format', async () => {
      await expect(component.quickExport('invalid' as any))
  ...
  describe('Custom Export', () => {
    ...
    it('should validate custom export options', async () => {
      ...
      await expect(component.createCustomExport(invalidOptions))
  ...
  describe('UI Interaction', () => {
    ...
    it('should fallback to execCommand for clipboard', async () => {
      ...
      (navigator.clipboard.writeText as jest.Mock).mockRejectedValue(new Error('Clipboard unavailable'));
